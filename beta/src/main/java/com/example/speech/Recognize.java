...
public class Recognize {
  ...
  public static void transcribeMultiLanguage(String fileName) throws Exception {
    ...
    try (SpeechClient speechClient = SpeechClient.create()) {
      ...
      PrintWriter writer = new PrintWriter("transcibe.txt", "UTF-8");
      // Print out the results
      recognizeResponse.getResultsList().stream().forEach(s -> writer.print(s.getAlternatives(0).getTranscript()));
